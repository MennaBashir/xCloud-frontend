...
export function FinalCta() {
	...
	return (
		<section ref={rootRef} className="relative py-24 sm:py-32 lg:py-40">
			<div className="container mx-auto px-4 sm:px-6">
				<div
					className="final-cta relative overflow-hidden rounded-[var(--radius-3xl)] border border-border bg-[oklch(0.16_0.06_280)] text-white p-10 sm:p-14 lg:p-20 flex flex-col items-center text-center gap-7"
				>
					{/* Mesh */}
					<div
						aria-hidden="true"
					...
					<h2 className="font-semibold tracking-tight leading-[1.06] text-[2rem] sm:text-[2.75rem] lg:text-[3.5rem] max-w-[18ch]">
						{t("finalCta.title")}
					</h2>
					...
					<div className="flex flex-col xs:flex-row items-center gap-3 mt-2">
						<Button
							asChild
							size="pill"
							className="group/btn bg-white text-foreground hover:bg-white/95"
						>
							<Link to="/signup">
