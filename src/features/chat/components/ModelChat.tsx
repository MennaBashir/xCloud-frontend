...
import ModelHeroContent from "./ModelHeroContent";
...
const suggestions = [
  ...
  "Are there any action items from the last meeting?",
  "What’s inside the Sprint2 file?",
  "Are there any tasks mentioned in the Sprint2 file?",
];
